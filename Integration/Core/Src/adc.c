...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  */
    ...
    PB14     ------> ADC1_IN5
    */
    GPIO_InitStruct.Pin = Acc_Zout_Pin|Acc_Yout_Pin;
  ...
  */
    ...
    PB15     ------> ADC2_IN15
    */
    GPIO_InitStruct.Pin = Acc_Xout_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(Acc_Xout_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB14     ------> ADC1_IN5
    */
    HAL_GPIO_DeInit(GPIOB, Acc_Zout_Pin|Acc_Yout_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PB15     ------> ADC2_IN15
    */
    HAL_GPIO_DeInit(Acc_Xout_GPIO_Port, Acc_Xout_Pin);
